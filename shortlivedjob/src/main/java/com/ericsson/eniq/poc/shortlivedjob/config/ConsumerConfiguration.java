package com.ericsson.eniq.poc.shortlivedjob.config;
...
public class ConsumerConfiguration {
	...
	@Value("${consumer.idle-event-interval}")
	...
	public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> batchFactory() {
		...
		factory.getContainerProperties().setIdleEventInterval(idleEventInterval);
